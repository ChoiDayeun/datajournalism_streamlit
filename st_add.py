...
offense_list = list(df_deaths_state['OFFENSE_NAME'].unique())
offense_list.sort()
#print(offense_list)


top10_df = df_deaths_state[df_deaths_state['STATE_NAME'] == 'TOP_10_COVID_DEATHS']
top10_2019 = top10_df[top10_df['DATA_YEAR'] == 2019]
top10_2020 = top10_df[top10_df['DATA_YEAR'] == 2020]
...
location_list = list(df_deaths_state['LOCATION_NAME'].unique())
location_list.sort()
...
#유형 과격성 - 상위10개
fig_offensetype_top10 = go.Figure()

fig_offensetype_top10 .add_trace(go.Bar(
  x = offense_list,
  y = offense_case_list_top_2019,
  name = "2019",
))

fig_offensetype_top10 .add_trace(go.Bar(
  x = offense_list,
  y = offense_case_list_top_2020,
  name = "2020",
))
...
#유형 과격성 - 하위10개
fig_offensetype_bottom10 = go.Figure()

fig_offensetype_bottom10 .add_trace(go.Bar(
  x = offense_list,
  y = offense_case_list_bottom_2019,
  name = "2019",
))

fig_offensetype_bottom10 .add_trace(go.Bar(
  x = offense_list,
  y = offense_case_list_bottom_2020,
  name = "2020",
))
...
#장소 공개성 - 상위10개
fig_locationtype_top10 = go.Figure()

fig_locationtype_top10 .add_trace(go.Bar(
  x = location_list,
  y = location_case_list_top_2019,
  name = "2019",
))

fig_locationtype_top10 .add_trace(go.Bar(
  x = location_list,
  y = location_case_list_top_2020,
  name = "2020",
))
...
#장소 공개성 - 하위10개
fig_locationtype_bottom10 = go.Figure()

fig_locationtype_bottom10 .add_trace(go.Bar(
  x = location_list,
  y = location_case_list_bottom_2019,
  name = "2019",
))

fig_locationtype_bottom10 .add_trace(go.Bar(
  x = location_list,
  y = location_case_list_bottom_2020,
  name = "2020",
))
...
#유형 과격성 - 상위10개
fig_offensetype_death_top10 = go.Figure()

fig_offensetype_death_top10.add_trace(go.Bar(
  x = offense_list,
  y = offense_death_list_top_2019,
  name = "2019",
))

fig_offensetype_death_top10.add_trace(go.Bar(
  x = offense_list,
  y = offense_death_list_top_2020,
  name = "2020",
))
...
#유형 과격성 - 하위10개
fig_offensetype_death_bottom10 = go.Figure()

fig_offensetype_death_bottom10.add_trace(go.Bar(
  x = offense_list,
  y = offense_death_list_bottom_2019,
  name = "2019",
))

fig_offensetype_death_bottom10.add_trace(go.Bar(
  x = offense_list,
  y = offense_death_list_bottom_2020,
  name = "2020",
))
...
#장소 공개성 - 상위10개
fig_locationtype_death_top10 = go.Figure()

fig_locationtype_death_top10.add_trace(go.Bar(
  x = location_list,
  y = location_death_list_top_2019,
  name = "2019",
))

fig_locationtype_death_top10.add_trace(go.Bar(
  x = location_list,
  y = location_death_list_top_2020,
  name = "2020",
))
...
#장소 공개성 - 하위10개
fig_locationtype_death_bottom10 = go.Figure()

fig_locationtype_death_bottom10.add_trace(go.Bar(
  x = location_list,
  y = location_death_list_bottom_2019,
  name = "2019",
))

fig_locationtype_death_bottom10.add_trace(go.Bar(
  x = location_list,
  y = location_death_list_bottom_2020,
  name = "2020",
))
