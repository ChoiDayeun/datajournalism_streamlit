...
fbi =  pd.read_csv("fbi_data_edited.csv")
...
# plt.pcolor(df_2019_c)
# plt.xticks(np.arange(0.5, len(df_2019_c.columns), 1), df_2019_c.columns)
# plt.yticks(np.arange(0.5, len(df_2019_c.index), 1), df_2019_c.index)
# plt.title('Asian Hate crimes at 2019', fontsize=20)
...
# plt.pcolor(df_2020_c)
# plt.xticks(np.arange(0.5, len(df_2020_c.columns), 1), df_2020_c.columns)
# plt.yticks(np.arange(0.5, len(df_2020_c.index), 1), df_2020_c.index)
# plt.title('Asian Hate crimes at 2020', fontsize=20)
# plt.xlabel('Month', fontsize=14)
# plt.ylabel('Day', fontsize=14)
# plt.colorbar()
# plt.show()
