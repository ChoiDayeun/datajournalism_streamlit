...
st.info('''
팬데믹이 시작된 2020년의 혐오 범죄 건수는 전년도 대비 30% 이상 증가해 전례를 찾아볼 수 없는 변화를 보였으며, 그중에서도 아시아인 대상 혐오 범죄는 55% 증가했습니다. 5년 전인 2015년에 비교했을 때는 283% 가량 증가한 수치입니다. 

전체 혐오 범죄 대비 아시아인 대상 혐오 범죄 비율 또한 2020년 최고치인 3.13%을 기록했습니다.에서 미국 전역의 혐오 범죄 건수를 피해대상(victims)별로 분류해 센 자료를 시각화한 결과, 2015년부터 2020년까지 미국 전역의 혐오 범죄 건수는 증가 양상을 보여 왔습니다.
        ''')    
...
st.info('''
2016년 대선이 있었던 11월 아시아인 혐오 범죄가 소폭 증가한 양상을 보이며, 이후 간헐적으로 발생 빈도가 높아지던 아시아인 혐오 범죄 건수는 2020년 코로나19가 창궐하며 정점을 찍었습니다. 

미국에 코로나19가 상륙해 가장 기승을 부리던 3월과 4월의 아시아인 혐오 범죄 건수는 각각 52건으로, 이전 최다발생 월인 2019년 12월의 22건보다도 2.5배가량 높은 수치입니다. 같은 해 10월까지 아시아인 대상 혐오 범죄 건수는 매월 20건 이상으로 유례없는 발생 현황을 보였습니다. 
        ''')
...
# #표 세트: 사망자 수 상위/하위 10개 주 기준 아시아인 대상 혐오 범죄 유형 과격성/장소 공개성 비교
...
# * 그렇다면 아시아인 대상 혐오범죄만 사망자 수 기준으로 상위 10개 주, 하위 10개 주별로 비교한 결과는 어떨까요?
# """)
